...
from .bundle_bokeh import BundleBokehFilterWheelController


class FactoryFilterWheel:
    """
    ...
    def generate_bundle(self, bundle_config: dict):
        ...
        if name in self.generated:
            print(
                "[SANITY] FactoryFilterWheel: BundleFilterWheelController with name {} \
                    already generated before!".format(name))
        # if bundle_config[widget_package]==bokeh ->
        foo = BundleBokehFilterWheelController(
